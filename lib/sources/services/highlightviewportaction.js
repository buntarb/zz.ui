...
zz.ui.services.HighlightViewportAction.prototype.viewportActionEndListener_ = function( evt ){
	...
	// If something goes wrong end highlighting after 100ms.
	this.highlightTimerId_ = goog.Timer.callOnce( function( ){
...
zz.ui.services.HighlightViewportAction.prototype.startHighlight_ = function( evt ){
    ...
    if( evt.original.clientX === 0 && evt.original.clientY === 0 ){
        ...
        var clientX = evt.original.clientX ?

			evt.original.clientX :
			evt.original.getBrowserEvent( ).touches[ 0 ].clientX;

        var clientY = evt.original.clientY ?

			evt.original.clientY :
			evt.original.getBrowserEvent( ).touches[ 0 ].clientY;
